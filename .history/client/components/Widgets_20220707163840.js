...
//// Widgets - Component Page

import React from 'react'
import {news, whoToFollow} from '../lib/static'
import { BiSearch } from 'react-icons/bi'

//// Styling the elements using tailwind css
const style = {
    wrapper: `flex-[1] p-4`,
...
const Widgets = () => {
  return (
    <div className={style.wrapper}>
        ...
        {/* ///display the sidebar with an icon an input field */}

        <div className={style.searchBar}>
            <BiSearch className={style.searchIcon}/>
            <input 
            type="text" 
            placeholder='Search on Twitter3.0' 
            className={style.inputBox}
            />
        </div>

        {/* display the Explore Section */}
        
        <div className={style.section}>

            <div className={style.title}>Explore</div>
            
            {/* Map through each items from the static data and display them */}
        ...
        {/* display the Who To Follow Section */}

        <div className={style.section}>

            <div className={style.title}>Follow on Twitter3.0</div>
