...
//// Upon clicking the mint button, Process this page

import { Dispatch, SetStateAction } from 'react'
import { GiEarthAmerica } from 'react-icons/gi'

//// Styling the elements of the page using tailwind css
const style = {
...
const InitialState = ({
  ...
  return (
    <div className={style.wrapper}>
      ...
      {/* Lower container with additional information */}
      <div className={style.lower}>
        <div className={style.visibility}>
          <GiEarthAmerica />
          <span className={style.visibilityText}>Everyone can see this image</span>
        </div>
        <div
          className={
