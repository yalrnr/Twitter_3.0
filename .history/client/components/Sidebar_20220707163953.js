        ...
        {/* Display the Navigation Bar Container with Icons and information about the selection of area on the screen
         Display the selected icon highlighted using different style and icon */}
            ...
            {/* ////// Minting Button */}
                ...
                className={style.tweetButton}>Mint Profile Image</div>
            </div>
            ...
            {/* ////Display the user's image while checking if it's an NFT */}
            ...
            {/* //// Display the user details */}
                ...
                <div className={style.profileRight}>
                    <div className={style.details}>
                        ...
                        <div className={style.handle}>@{currentAccount.slice(0,4)}...{currentAccount.slice(-2)}</div>
                    </div>
