...
///// Function to add the data to the IPFS using pinata cloud services, to be used while minting the NFT Images

import axios from 'axios'

//// function to add json files to the ipfs
...
//// function to pin files to the ipfs
