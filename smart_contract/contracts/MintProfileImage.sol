...
////////Smart Contract to run on Blockchain Network to mint NFTS --- ERC721 Standard
...
contract ProfileImageNfts is ERC721, Ownable {
    ...
    /// Works as Structure as well as function for storing the data for further use
    struct RenderToken{
        uint256 id;
        string uri;
        string space;
    ...
    /// To Store the Metadata about tokens
    ...
    /// Function to get all the tokens generated
